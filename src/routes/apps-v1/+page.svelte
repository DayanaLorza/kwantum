...
<Seo
  title="Apps (Rev A archive) | Kwantum Tech"
  noindex={true}
  ...
  <section class="v2hero">
    <div class="v2hero__inner">
      <div class="hero__copy">
        <p class="hero__eyebrow">Kwantum Tech <span class="sep">·</span> DWG NO. KT-26 <span class="sep">·</span> Apps <span class="sep">·</span> REV A · ARCHIVE</p>
